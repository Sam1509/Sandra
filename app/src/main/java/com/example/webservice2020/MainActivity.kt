...
class MainActivity : AppCompatActivity() {
        ...
        val jsonObjectRequest = JsonObjectRequest(
            ...
            Response.Listener { response ->
                ...
                for (i in 0 until sensadoJson.length()){
                    ...
                    val sentencia = "Insert into sensado(idsen,nomsensor,valor) values (${ids}, '${nom}',${valor})"
                    val res = admin.Ejecuta(sentencia)
                }
            },
            Response.ErrorListener { error ->
                Toast.makeText(this, "Error getAllSensor: " + error.message.toString() , Toast.LENGTH_LONG).show();
    ...
    fun Eliminar(v:View){
        if (etId.text.toString().isEmpty()){
            Toast.makeText(this, "Falta información de capturar",
